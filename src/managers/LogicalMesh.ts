...
export class LogicalMesh {
    ...
    // // Operations
    // extrudeFace(faceID: string, distance: number): void {
    //   const face = this.heds.getFaceById(faceID);
    //   this.heds = extrudeFace(this.heds, face, distance);
    // }
  
    // // Extract raw arrays
    // getPositions(): number[] { /* traverse vertices */ }
    // getIndices(): number[] { /* traverse faces */ }
}